...
const AccountSetupWizard: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateStep(currentStep)) {
      alert(
        `Form submitted successfully with data: ${JSON.stringify(formData)}`,
      );
  ...
  //   const slides = ["Face shape", "Eyes", "Nose", "Mouth", "Hair", "Clothes"];
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-10 max-w-3xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex justify-between mb-2">
                {["Personal Info", "Account Details"].map(
                  // {["Personal Info", "Account Details", "Avatar"].map(
                  (label, index) => {
                    const step = index + 1;
                    return (
                      <span
